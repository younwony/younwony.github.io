...
└── blog/                              # 블로그 콘텐츠 아카이브 (NEW!)
    ├── README.md                     # 블로그 구조 안내
    ├── project/                      # 프로젝트 카테고리
    │   └── ddangbbo.md              # 모바일 청첩장 프로젝트
    ├── study/                        # 스터디 카테고리
    │   ├── cleancode.md             # Clean Code 스터디 (19개)
    │   ├── effective_java.md        # Effective Java 스터디 (4개)
    │   ├── together_growing.md      # 함께자라기 스터디 (4개)
    │   └── oop_facts.md             # 객체지향의 사실과 오해 (3개)
    ├── live_study/                   # Java Live-Study 카테고리
    │   └── java_live_study.md       # Java 기초 학습 (13주차)
    ├── algorithm/                    # 알고리즘 카테고리
    │   └── algorithm_solutions.md   # LeetCode/Programmers 풀이 (9개)
    ├── devops/                       # DevOps 관련 카테고리
    │   ├── ide.md                   # IntelliJ 팁 (8개)
    │   ├── database.md              # DBMS 관련 (5개)
    │   ├── linux.md                 # Linux/CentOS 설정 (3개)
    │   ├── server.md                # Server 관련 (2개)
    │   └── aws.md                   # AWS 관련 (1개)
    └── etc/                          # 기타 카테고리
        ├── frontend.md              # FrontEnd (1개)
        ├── framework.md             # Framework (1개)
        ├── opensource.md            # Open Sources (1개)
        └── python.md                # Python (1개)
```
...
### 4. 블로그 콘텐츠 (`blog/`)
[12Dev 기술 블로그](https://youn12.tistory.com)의 80개 포스트를 체계적으로 정리한 아카이브입니다.

#### 주요 카테고리
| 카테고리 | 포스트 수 | 설명 |
|----------|----------|------|
| **project** | 5개 | 모바일 청첩장 프로젝트 (ddangbbo) |
| **study** | 30개 | Clean Code, Effective Java, 함께자라기 등 |
| **live_study** | 13개 | Java 기초 학습 (13주차) |
| **algorithm** | 9개 | LeetCode, Programmers 풀이 |
| **devops** | 19개 | IntelliJ, DBMS, Linux, Server, AWS |
| **etc** | 4개 | FrontEnd, Framework, Python 등 |

자세한 내용은 [`blog/README.md`](blog/README.md) 참조
...
- **2025-12-01**: 블로그 콘텐츠 아카이브 (`blog/`) 추가 - 80개 포스트 정리
