...
Java/Spring 기반 7년차 백엔드 개발자입니다. 커머스 플랫폼의 상품·가격·주문·검색 영역에서 **성능·확장성·운영 효율**을 동시에 고려한 설계를 지향합니다. 현재는 200만 인플루언서 데이터 플랫폼을 구축하며 새로운 비즈니스 성장에 기여하고 있습니다.
...
- **해결**: Elasticsearch 역색인 기반 검색 엔진 + 멀티소스 API 파이프라인
...
- **해결**: 카테고리/브랜드 타겟팅 최저가 자동 조정 + MD팀 협업 체계
