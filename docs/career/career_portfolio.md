...
## 프로젝트 5: 개발 문화 개선 및 AI 기반 팀 생산성 혁신

### 📌 Situation (배경 및 문제점)

- 팀 내 통일된 코드 컨벤션과 리뷰 프로세스 부재로 개발자마다 스타일이 상이, 협업 비용 증가 및 품질 저하 발생
- 코드 리뷰 없이 배포되어 운영 장애 및 사이드 이펙트 반복 발생
- 월간/일간 운영성 반복 업무(로그 조회, 데이터 추출, 어드민 기능 개발)에 시니어 개발자 리소스가 과다 투입되어 핵심 개발 시간 부족

### 🎯 Task (과제/목표)

- 건강한 코드 리뷰 문화와 품질 기준을 정착시켜 운영 장애 사전 차단
- AI 에이전트 기반 자동화로 반복 업무를 흡수하여 팀 리소스 최적화
...
**4. 운영 툴 내재화**
- 반복 업무를 내부 시스템 기능으로 내재화하여 누구나 즉시 활용 가능하도록 구조화
- 사내 맞춤형 운영 툴 5건 이상 신규 구축

**5. 팀 내 AI 활용 전파**
- 프롬프트 엔지니어링 노하우와 AI 활용 패턴을 팀 내 공유
...
- 운영성 업무 자동화로 백엔드 팀 생산성 비약적 향상

### 🔧 Tech Decision

> "AI Agent(Claude Code) 도입 - 자연어 명령으로 SQL/스크립트 생성, 반복 업무 90% 시간 단축 및 팀 전체 활용 가능"

### 사용 기술
Java, Spring Boot, Claude Code (AI Agent), Code Review, Clean Code
